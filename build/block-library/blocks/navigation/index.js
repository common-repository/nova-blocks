...
/***/ "./packages/block-library/build/blocks/navigation/icon.svg":
/*!*****************************************************************!*\
  !*** ./packages/block-library/build/blocks/navigation/icon.svg ***!
  \*****************************************************************/
...
var symbol = new _node_modules_svg_baker_runtime_browser_symbol_js__WEBPACK_IMPORTED_MODULE_0___default.a({
  "id": "block-library-navigation/icon",
  "use": "block-library-navigation/icon-usage",
  "viewBox": "0 0 24 24",
  "content": "<symbol fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" id=\"block-library-navigation/icon\"><path fill-rule=\"evenodd\" clip-rule=\"evenodd\" d=\"M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zM5.857 8A.857.857 0 0 1 5 7.143C5 6.512 5.512 6 6.143 6H18a1 1 0 1 1 0 2H5.857zM5 12.143c0 .473.384.857.857.857H18a1 1 0 1 0 0-2H6.143C5.512 11 5 11.512 5 12.143zM5.857 18A.857.857 0 0 1 5 17.143C5 16.512 5.512 16 6.143 16H18a1 1 0 1 1 0 2H5.857z\" fill=\"#6565F2\" /></symbol>"
});
...
var _icon = _interopRequireDefault(__webpack_require__(/*! ./icon.svg */ "./packages/block-library/build/blocks/navigation/icon.svg"));
...
(0, _blocks.registerBlockType)('novablocks/navigation', {
  ...
  edit: function edit(props) {
    ...
    (0, _blockEditor.useSelectParent)(props);
    (0, _element.useLayoutEffect)(function () {
      ...
      if (parent) {
        ...
        var observer = new MutationObserver(function (mutationsList) {
          (0, _utils.addSocialMenuClass)(parent);
        });
    ...
    return (0, _element.createElement)(_serverSideRender.default, {
      ...
      className: "block-".concat(clientId)
    });
  },
  save: function save() {
    return false;
