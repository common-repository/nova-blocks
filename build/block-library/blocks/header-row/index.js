...
/******/ 	return __webpack_require__(__webpack_require__.s = "./packages/block-library/build/blocks/header-row/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./packages/block-library/build/blocks/header-row/edit.js":
/*!****************************************************************!*\
  !*** ./packages/block-library/build/blocks/header-row/edit.js ***!
  \****************************************************************/
/*! no static exports found */
 ...
 */
var ALLOWED_BLOCKS = ['novablocks/logo', 'novablocks/navigation'];
...
var HeaderRowEdit = withControlsVisibility(function (props) {
  var attributes = props.attributes;
  var align = attributes.align,
      slug = attributes.slug;
  var blockProps = (0, _blockEditor.useBlockProps)({
    className: (0, _classnames2.default)('nb-header-row', (0, _defineProperty2.default)({}, "nb-header--".concat(slug), !!slug), (0, _utils.getColorSignalClassnames)(attributes, true), props.className, "alignfull"),
    style: props.style
  });
  var fakeBlockClassname = (0, _classnames2.default)('wp-block', "align".concat(align));
  var innerBlockProps = (0, _blockEditor.useInnerBlocksProps)({}, {
    allowedBlocks: ALLOWED_BLOCKS,
    renderAppender: false,
    templateLock: 'insert'
  });
  return (0, _element.createElement)("div", blockProps, (0, _element.createElement)("div", {
    className: "nb-header-row__inner-container"
  }, (0, _element.createElement)("div", (0, _extends2.default)({}, innerBlockProps, {
    className: fakeBlockClassname
  }))));
});
var _default = HeaderRowEdit;
exports.default = _default;


/***/ }),

/***/ "./packages/block-library/build/blocks/header-row/icon.svg":
/*!*****************************************************************!*\
  !*** ./packages/block-library/build/blocks/header-row/icon.svg ***!
  \*****************************************************************/
...
var symbol = new _node_modules_svg_baker_runtime_browser_symbol_js__WEBPACK_IMPORTED_MODULE_0___default.a({
  "id": "block-library-header-row/icon",
  "use": "block-library-header-row/icon-usage",
  "viewBox": "0 0 24 24",
  "content": "<symbol fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" id=\"block-library-header-row/icon\"><path d=\"M0 12C0 5.373 5.373 0 12 0s12 5.373 12 12-5.373 12-12 12S0 18.627 0 12Z\" fill=\"#6565F2\" /><path d=\"M3 11.857C3 13.041 3.96 14 5.143 14h.584A2.273 2.273 0 0 0 8 11.727v-.804A1.923 1.923 0 0 0 6.077 9h-.22A2.857 2.857 0 0 0 3 11.857Z\" fill=\"#FFE42E\" /><path d=\"M10 11.857c0 1.184.96 2.143 2.143 2.143H18.5a2.5 2.5 0 0 0 0-5h-5.643A2.857 2.857 0 0 0 10 11.857Z\" fill=\"#fff\" /></symbol>"
});
...
/***/ "./packages/block-library/build/blocks/header-row/index.js":
/*!*****************************************************************!*\
  !*** ./packages/block-library/build/blocks/header-row/index.js ***!
  \*****************************************************************/
/*! no static exports found */
...
var _icon = _interopRequireDefault(__webpack_require__(/*! ./icon.svg */ "./packages/block-library/build/blocks/header-row/icon.svg"));

var _edit = _interopRequireDefault(__webpack_require__(/*! ./edit */ "./packages/block-library/build/blocks/header-row/edit.js"));
...
(0, _hooks.addFilter)('blocks.registerBlockType', 'novablocks/header-row/attributes-overwrite', overwriteAttributes, Number.MAX_SAFE_INTEGER);
