...
/***/ "./packages/block-library/build/blocks/opentable/icon.svg":
/*!****************************************************************!*\
  !*** ./packages/block-library/build/blocks/opentable/icon.svg ***!
  \****************************************************************/
...
var _icon = _interopRequireDefault(__webpack_require__(/*! ./icon.svg */ "./packages/block-library/build/blocks/opentable/icon.svg"));
...
(0, _blocks.registerBlockType)('novablocks/opentable', {
  title: (0, _i18n.__)('OpenTable Reservation', 'nova-blocks'),
  description: (0, _i18n.__)('Add OpenTable online reservation booking to your site.', 'nova-blocks'),
  category: 'nova-blocks',
  icon: (0, _blockEditor.getSvg)(_icon.default),
  // Additional search terms
  keywords: [(0, _i18n.__)('reservations', 'nova-blocks'), (0, _i18n.__)('bookings', 'nova-blocks')],
...
var alterAttributes = function alterAttributes(settings) {
  if (settings.name !== 'novablocks/opentable') {
    return settings;
  }

  return _objectSpread(_objectSpread({}, settings), {}, {
    attributes: _objectSpread(_objectSpread({}, settings.attributes), attributesColorSignal)
  });
};

(0, _hooks.addFilter)('blocks.registerBlockType', 'novablocks/opentable/color-signal-attributes-overwrite', alterAttributes, 20);
...
var OpenTableInspectorControls = function OpenTableInspectorControls(props) {
  ...
  return (0, _element.createElement)(_element.Fragment, null, (0, _element.createElement)(_blockEditor.ControlsSection, {
    ...
    label: (0, _i18n.__)('Restaurant ID', 'nova-blocks'),
    placeholder: (0, _i18n.__)('1', 'nova-blocks'),
    help: (0, _i18n.__)('You can find your restaurant ID on the OpenTable website.', 'nova-blocks'),
    type: "number",
    value: restaurantId,
    ...
    label: (0, _i18n.__)('Language', 'nova-blocks'),
    value: language,
    options: [{
      label: (0, _i18n.__)('English-EN', 'nova-blocks'),
      value: 'en-US'
    }, {
      label: (0, _i18n.__)('French-CA', 'nova-blocks'),
      value: 'fr-CA'
    }, {
      label: (0, _i18n.__)('Deutsch-DE', 'nova-blocks'),
      value: 'de-DE'
    }, {
      label: (0, _i18n.__)('Spanish-MX', 'nova-blocks'),
      value: 'es-MX'
    }, {
      label: (0, _i18n.__)('Japanese-JP', 'nova-blocks'),
      value: 'ja-JP'
    }, {
      label: (0, _i18n.__)('Dutch-NL', 'nova-blocks'),
      value: 'nl-NL'
    }, {
      label: (0, _i18n.__)('Italian-IT', 'nova-blocks'),
      value: 'it-IT'
    }],
    ...
    selected: layoutForm,
    options: [{
      label: (0, _i18n.__)('Horizontal', 'nova-blocks'),
      value: 'wide'
    }, {
      label: (0, _i18n.__)('Vertical', 'nova-blocks'),
      value: 'standard'
    }],
    ...
    label: (0, _i18n.__)('Show OpenTable Logo', 'nova-blocks'),
...
var grabStylesheet = function grabStylesheet(url) {
  return url && "<link rel=\"stylesheet\" href=\"".concat(url, "\" type=\"text/css\"/>") || '';
};
...
var OpenTablePreview = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2.default)(OpenTablePreview, [{
    ...
    value: function render() {
      var _window, _window$styleManager, _window2, _window2$styleManager, _novablocks_urls, _novablocks_urls2, _novablocks_urls3, _novablocks_urls4;
      ...
      }, (0, _utils.getColorSignalClassnames)(this.props.attributes, true));

      var OpenTable = function OpenTable(props) {
        return (0, _element.createElement)(_components.SandBox, props);
      };

      var html = "<div class=\"novablocks-opentable ".concat(classNames, "\">") + "<script type='text/javascript' src='//www.opentable.com/widget/reservation/loader?rid=".concat(restaurantId, "&type=standard&theme=").concat(layoutForm, "&iframe=false&overlay=false&domain=com&lang=").concat(language, "'></script>") + grabStylesheet((_window = window) === null || _window === void 0 ? void 0 : (_window$styleManager = _window.styleManager) === null || _window$styleManager === void 0 ? void 0 : _window$styleManager.colorsCustomPropertiesUrl) + (((_window2 = window) === null || _window2 === void 0 ? void 0 : (_window2$styleManager = _window2.styleManager) === null || _window2$styleManager === void 0 ? void 0 : _window2$styleManager.frontendOutput) && "<style>".concat(window.styleManager.frontendOutput, "</style>") || '') + grabStylesheet((_novablocks_urls = novablocks_urls) === null || _novablocks_urls === void 0 ? void 0 : _novablocks_urls.novablocks_core_frontend_stylesheet) + grabStylesheet((_novablocks_urls2 = novablocks_urls) === null || _novablocks_urls2 === void 0 ? void 0 : _novablocks_urls2.novablocks_components_frontend_stylesheet) + grabStylesheet((_novablocks_urls3 = novablocks_urls) === null || _novablocks_urls3 === void 0 ? void 0 : _novablocks_urls3.novablocks_opentable_frontend_stylesheet) + grabStylesheet((_novablocks_urls4 = novablocks_urls) === null || _novablocks_urls4 === void 0 ? void 0 : _novablocks_urls4.novablocks_opentable_editor_stylesheet) + '</div>';
...
var OpenTableSave = function OpenTableSave(props) {
  ...
  var restaurantId = attributes.restaurantId,
      language = attributes.language,
      showOpenTableLogo = attributes.showOpenTableLogo,
      layoutForm = attributes.layoutForm;
  ...
  }, (0, _utils.getColorSignalClassnames)(attributes, true));
