...
/******/ 	return __webpack_require__(__webpack_require__.s = "./packages/block-library/build/blocks/post-comments/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./packages/block-library/build/blocks/post-comments/edit.js":
/*!*******************************************************************!*\
  !*** ./packages/block-library/build/blocks/post-comments/edit.js ***!
  \*******************************************************************/
/*! no static exports found */
...
var _inspectorControls = _interopRequireDefault(__webpack_require__(/*! ./inspector-controls */ "./packages/block-library/build/blocks/post-comments/inspector-controls.js"));

/**
 * WordPress dependencies
 */
var PostCommentsEdit = function PostCommentsEdit(props) {
  var context = props.context,
      hasUserExperience = props.attributes.hasUserExperience;
  var commentStatus = (0, _data.useSelect)(function (select) {
    return select('core/editor').getEditedPostAttribute('comment_status');
  });
  var postId = context.postId,
      postType = context.postType;
  var className = (0, _classnames.default)('novablocks-conversations', props.className);
  ...
  if (!postType || !postId) {
    return (0, _element.createElement)("div", blockProps, (0, _element.createElement)(_inspectorControls.default, props), (0, _element.createElement)(_components.Placeholder, null, (0, _i18n.__)('Nova Blocks: Conversation System Block.', 'nova-blocks')));
  }

  if ('open' !== commentStatus) {
    return (0, _element.createElement)("div", blockProps, (0, _element.createElement)(_blockEditor.Warning, null, (0, _i18n.__)('Comments are disabled for this post', 'nova-blocks')));
  }

  return (0, _element.createElement)("div", blockProps, (0, _element.createElement)("div", {
    className: "novablocks-conversations__container"
  }, (0, _element.createElement)("h3", {
    className: "novablocks-conversations__title"
  }, (0, _i18n.__)('Conversations', 'nova-blocks')), (0, _element.createElement)("div", {
    className: "comment-form form-grid"
    ...
    className: "comment-label__container"
  }, (0, _element.createElement)("label", {
    htmlFor: "comment"
  }, (0, _i18n.__)('What’s your comment or question?', 'nova-blocks')), (0, _element.createElement)("span", {
    className: "field-description"
  }, (0, _i18n.__)('Let’s start a personal and a meaningful conversation. ', 'nova-blocks'))), (0, _element.createElement)("textarea", {
    name: "comment",
    id: "comment",
    cols: "30",
    rows: "1",
    placeholder: (0, _i18n.__)('Join the conversation, share your knowledge or ask a question...', 'nova-blocks')
  })), (0, _element.createElement)("div", {
    className: "second-column"
  }, (0, _element.createElement)("p", {
    className: "comment-form-background"
  }, (0, _element.createElement)("label", {
    htmlFor: "experience"
  }, (0, _i18n.__)('What is your expertise or qualification in this topic?', 'nova-blocks')), (0, _element.createElement)("span", {
    className: "field-description"
  }, (0, _i18n.__)('Example: Practical philosopher, therapist and writer.', 'nova-blocks')), (0, _element.createElement)("input", {
    id: "experience",
    name: "experience",
    type: "text",
    value: "",
    ...
    maxLength: "245",
    required: "required",
    placeholder: (0, _i18n.__)('Your relevant experience or expertise...', 'nova-blocks')
  })), (0, _element.createElement)("p", {
    className: "comment-form-author"
  }, (0, _element.createElement)("label", {
    htmlFor: "author"
  }, (0, _i18n.__)('What is your name?', 'nova-blocks')), (0, _element.createElement)("span", {
    className: "required"
    ...
    maxLength: "245",
    required: "required",
    placeholder: (0, _i18n.__)('eg. John Doe', 'nova-blocks')
  })), (0, _element.createElement)("p", {
    className: "comment-form-email"
  }, (0, _element.createElement)("label", {
    htmlFor: "email"
  }, (0, _i18n.__)('What is your email address?', 'nova-blocks')), (0, _element.createElement)("span", {
    className: "field-description"
  }, (0, _i18n.__)('Your email address will not be published.', 'nova-blocks')), (0, _element.createElement)("input", {
    id: "email",
    name: "email",
    type: "email",
    value: "",
    ...
    maxLength: "100",
    required: "required",
    placeholder: (0, _i18n.__)('your@email.com', 'nova-blocks')
  })), (0, _element.createElement)("div", {
  ...
  }, (0, _i18n.__)('Add this comment', 'nova-blocks')))))), (0, _element.createElement)("div", {
    className: "novablocks-conversations__comment-list comment-list"
  ...
  return (0, _data.useSelect)(function (select) {
    ...
    return comments && comments.length ? comments.map(function (comment) {
      return (0, _element.createElement)("div", {
        ...
        className: "comment-body comment-grid"
      }, (0, _element.createElement)("div", {
        className: "comment-content"
      }, (0, _element.createElement)("div", {
        className: "comment-author-avatar vcard"
      }, (0, _element.createElement)("img", {
        className: "avatar",
      ...
      }, comment.author_name)), (0, _element.createElement)("div", {
        className: "comment-text"
      }, (0, _element.createElement)(_element.RawHTML, null, comment.content.rendered)), (0, _element.createElement)("div", {
        className: "comment-footer"
      }, (0, _element.createElement)("span", {
        className: "comment-posted-time"
      }, moment(comment.date).fromNow())))));
    }) : (0, _i18n.__)('No comments.', 'nova-blocks');
  }, [postId]);
}

;
var _default = PostCommentsEdit;
exports.default = _default;


/***/ }),

/***/ "./packages/block-library/build/blocks/post-comments/icon.svg":
/*!********************************************************************!*\
  !*** ./packages/block-library/build/blocks/post-comments/icon.svg ***!
  \********************************************************************/
...
var symbol = new _node_modules_svg_baker_runtime_browser_symbol_js__WEBPACK_IMPORTED_MODULE_0___default.a({
  "id": "block-library-post-comments/icon",
  "use": "block-library-post-comments/icon-usage",
  "viewBox": "0 0 24 24",
  "content": "<symbol fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\" id=\"block-library-post-comments/icon\"><path fill-rule=\"evenodd\" clip-rule=\"evenodd\" d=\"M12 0c6.627 0 12 5.373 12 12s-5.373 12-12 12S0 18.627 0 12 5.373 0 12 0ZM7 7a4 4 0 0 0-4 4 2 2 0 0 0 2 2h3a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2H7Zm9-3a4 4 0 0 1 4 4v8a3.999 3.999 0 0 1-2.082 3.511C16.949 20.041 16 19.105 16 18v-3a2 2 0 0 0-2-2 2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2ZM8 15a2 2 0 0 0-2 2 4 4 0 0 0 4 4h2a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2H8Z\" fill=\"#6565F2\" /></symbol>"
});
...
/***/ "./packages/block-library/build/blocks/post-comments/index.js":
/*!********************************************************************!*\
  !*** ./packages/block-library/build/blocks/post-comments/index.js ***!
  \********************************************************************/
/*! no static exports found */
...
var _icon = _interopRequireDefault(__webpack_require__(/*! ./icon.svg */ "./packages/block-library/build/blocks/post-comments/icon.svg"));

var _edit = _interopRequireDefault(__webpack_require__(/*! ./edit */ "./packages/block-library/build/blocks/post-comments/edit.js"));
 ...
 * WordPress dependencies
 */
(0, _blocks.registerBlockType)('novablocks/post-comments', {
...
/***/ "./packages/block-library/build/blocks/post-comments/inspector-controls.js":
/*!*********************************************************************************!*\
  !*** ./packages/block-library/build/blocks/post-comments/inspector-controls.js ***!
  \*********************************************************************************/
/*! no static exports found */
...
// Import useEffect
var PostCommentsInspectorControls = function PostCommentsInspectorControls(props) {
  var attributes = props.attributes,
      setAttributes = props.setAttributes;
  var _attributes$hasUserEx = attributes.hasUserExperience,
      hasUserExperienceAttribute = _attributes$hasUserEx === void 0 ? true : _attributes$hasUserEx;

  var _useState = (0, _element.useState)(hasUserExperienceAttribute),
      _useState2 = (0, _slicedToArray2.default)(_useState, 2),
      hasUserExperience = _useState2[0],
      setHasUserExperience = _useState2[1];
  ...
  return (0, _element.createElement)(_element.Fragment, null, (0, _element.createElement)(_blockEditor.ControlsSection, {
    id: 'layout',
    order: 10,
    label: (0, _i18n.__)('Elements Visibility', 'nova-blocks'),
  ...
  }, (0, _element.createElement)(_blockEditor.ControlsGroup, null, (0, _element.createElement)(_components.ToggleControl, {
    label: "User Background or Experience",
    help: hasUserExperience ? 'Display user background field.' : 'Hide the user background field.',
...
var _default = PostCommentsInspectorControls;
exports.default = _default;
