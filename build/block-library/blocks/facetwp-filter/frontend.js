...
/******/ 	return __webpack_require__(__webpack_require__.s = "./packages/block-library/build/blocks/facetwp-filter/frontend.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./packages/block-library/build/blocks/facetwp-filter/frontend.js":
/*!************************************************************************!*\
  !*** ./packages/block-library/build/blocks/facetwp-filter/frontend.js ***!
  \************************************************************************/
...
(0, _domReady.default)(function () {
  var blocks = Array.from(document.querySelectorAll('.nb-facetwp-filter'));
  var hiddenBlocks = blocks.filter(function (block) {
    return (0, _utils.hasClass)(block, 'nb-facetwp-filter--section-type-hidden');
  });
  blocks.forEach(function (block) {
    var toggles = block.querySelectorAll('.nb-facetwp-toggle');
    toggles.forEach(function (toggle) {
      ...
      toggle.addEventListener('click', function () {
        ...
        hiddenBlocks.forEach(function (hiddenBlock) {
          (0, _utils.toggleClass)(hiddenBlock, 'is-visible', toggle.dataset.toggled === "true");
        });
      });
    });
  });
